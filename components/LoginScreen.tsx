    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            if (error.code === 'auth/unauthorized-domain') {
                 ...
                 displayError = "Login com Google não está ativado. Ative em Firebase Console -> Authentication -> Sign-in method -> Google.";
            }
    ...
    const handleEmailAuth = async (e: React.FormEvent) => {
        ...
        try {
             ...
             if (error.code === 'auth/email-already-in-use') {
                 ...
                 setErrorMsg("Login por email não está ativado. Ative em Firebase Console -> Authentication -> Sign-in method -> Email/Password.");
             } else {
